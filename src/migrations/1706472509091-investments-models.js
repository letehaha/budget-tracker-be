...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await queryInterface.createTable(SECURITIES_NAME, {
        id: {
          allowNull: false,
          autoIncrement: true,
          primaryKey: true,
      ...
      await queryInterface.createTable(HOLDINGS_NAME, {
        id: {
          allowNull: false,
          autoIncrement: true,
          primaryKey: true,
      ...
      await queryInterface.createTable(INVESTMENT_TRANSACTIONS_NAME, {
        id: {
          allowNull: false,
          autoIncrement: true,
          primaryKey: true,
        ...
        category: {
          type: Sequelize.ENUM('buy', 'sell', 'dividend', 'transfer', 'tax', 'fee', 'cancel', 'other'),
          allowNull: false,
          defaultValue: 'buy'
        },
        transferNature: {
       ...
       */
      await queryInterface.createTable(SECURITY_PRICINGS_NAME, {
        securityId: {
          primaryKey: true,
          type: Sequelize.INTEGER,
          allowNull: false,
